...
class Interview:
    ...
    def _generate_introduction_question(self) -> str:
        ...
        try:
            ...
            return "Hello! Thank you for joining us today. Could you please introduce yourself and tell me a bit about your background and experience?"
...
"""
    ...
    def _generate_closing_statement(self) -> str:
        ...
        try:
            ...
            prompt = """You are an experienced HR interviewer concluding a job interview.
            Create a warm, professional closing statement thanking the candidate for their time.
            Mention that you've gathered valuable insights about their experience and skills.
            Inform them about next steps in general terms, without making specific promises.
            ...
            return "Thank you for taking the time to interview with us today. We appreciate your thoughtful responses and sharing your experience. Our team will review the interview and be in touch regarding next steps. Have a great day!"
